  ...
  return (
    <section className={styles.hero}>
      <div className={styles.inner}>
        ...
        <div className={styles.updated}>最終データ更新：2026年4月2日 19:46</div>
        ...
        <p className={styles.desc}>
          {universityInfo.openingYear}開学予定のコーイノベーション大学（CoIU）について、5つのアプローチと3つのシナリオによる多角的な入学者数予測を分析します。
          申請書類・飛騨市統計・リクルート進学総研データ等をもとに厳格に検証しています。
        </p>
